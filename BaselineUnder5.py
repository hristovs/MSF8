...
for i in range(0,weeks):
    for j in range(0,days):
        baselinePart.append(baselineFunc(get_date(i,j), day_shift, under_5))
        baselinePart.append(baselineFunc(get_date(i,j), night_shift, under_5))
        reactivePart.append(100-(baselineFunc(get_date(i,j), day_shift, under_5)))
        reactivePart.append(100-(baselineFunc(get_date(i,j), night_shift, under_5)))
...
plt.title('Time Spent on Baseline vs Reactive Care (Under 5 Ward)')
